...
/**
 * Обычной клиент (рабочий поток).
 * Для обмена данными с s2s-сервером.
 * Используется по-умолчанию, если не указать иной тип протокола.
 * <p>
 ...
 */
class DefaultClient extends WorkerThread
    ...
    DefaultClient(ClientController owner, Target target, Logger parent, int index, String[][] commandsList) {
        this.owner = owner;
        this.target = target;
    ...
    public boolean equals(Object o) {
        return o instanceof DefaultClient && index == ((DefaultClient) o).index;
    }
