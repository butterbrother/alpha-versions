...
func main() {
	...
	{
		slice1 := []int{1,2,3}
		// append - дописывает в конец среза все последующие
		// аргументы
		slice2 := append(slice1, 4, 5)
		fmt.Println(slice2)
		slice3 := make([]int, 2)
		// copy - копирование. copy(получатель, источник)
		// заполниет по всей длине получателя, если источник
		// больше - остальные данные будут отброшены
		copy(slice3, slice2)
		fmt.Println(slice3)
	}
	// Карты, местные коллекции
	{
		// Объявление непроинициализированной карты
		//map[ключ]тип_данных
